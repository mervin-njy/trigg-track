import "./chunk-KZKPIYYE.js";
import "./chunk-HCX2OTMO.js";
import {
  firebase
} from "./chunk-MBAJR6G4.js";
import "./chunk-JRVXFSYG.js";
import "./chunk-BQCZIERH.js";
import {
  Component,
  ComponentContainer,
  Deferred,
...
var version6 = "0.14.0";
var SDK_VERSION2 = "";
function setSDKVersion(version19) {
  SDK_VERSION2 = version19;
}
var DOMStorageWrapper = class {
  ...
  prefixedName_(name19) {
    return this.prefix_ + name19;
  }
  toString() {
...
var StatsCollection = class {
  ...
  incrementCounter(name19, amount = 1) {
    if (!contains(this.counters_, name19)) {
      this.counters_[name19] = 0;
    }
    this.counters_[name19] += amount;
  }
  get() {
...
var NamedNode = class {
  constructor(name19, node) {
    this.name = name19;
    this.node = node;
  }
  static Wrap(name19, node) {
    return new NamedNode(name19, node);
  }
};
var Index = class {
  /**
...
var PriorityIndex = class extends Index {
  ...
  makePost(indexValue, name19) {
    ...
    return new NamedNode(name19, new LeafNode("[PRIORITY-POST]", priorityNode));
  }
  /**
   * @returns String representation for inclusion in a query spec
   */
...
var ValueIndex = class extends Index {
  ...
  makePost(indexValue, name19) {
    const valueNode = nodeFromJSON(indexValue);
    return new NamedNode(name19, valueNode);
  }
  /**
   * @returns String representation for inclusion in a query spec
   */
...
function viewProcessorAckUserWrite(viewProcessor, viewCache, ackPath, affectedTree, writesCache, completeCache, accumulator) {
  ...
  if (affectedTree.value != null) {
    if (pathIsEmpty(ackPath) && serverCache.isFullyInitialized() || serverCache.isCompleteForPath(ackPath)) {
      ...
      serverCache.getNode().forEachChild(KEY_INDEX, (name19, node) => {
        changedChildren = changedChildren.set(new Path(name19), node);
      });
...
var Tree = class {
   ...
   */
  constructor(name19 = "", parent2 = null, node = { children: {}, childCount: 0 }) {
    this.name = name19;
    this.parent = parent2;
    this.node = node;
  }
...
function push(parent2, value) {
  ...
  const name19 = nextPushId(now);
  const thennablePushRef = child(parent2, name19);
  const pushRef = child(parent2, name19);
  let promise;
  if (value != null) {
...
var name7 = "@firebase/database-compat";
var version7 = "0.3.0";
...
var CachingClient = class {
  constructor(client, storage, storageCache, logger5) {
    this.client = client;
    this.storage = storage;
...
function registerRemoteConfig() {
  ...
  function remoteConfigFactory2(container, { instanceIdentifier: namespace }) {
    ...
    const logger5 = new Logger(name16);
    ...
    const cachingClient = new CachingClient(retryingClient, storage, storageCache, logger5);
    const remoteConfigInstance = new RemoteConfig(app, cachingClient, storageCache, storage, logger5);
...
@firebase/messaging/dist/index.sw.esm2017.js:
  (**
   * @license
   * Copyright 2019 Google LLC
   *
